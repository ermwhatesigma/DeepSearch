...
DeepSearch is a simple script i made. It's used to search people's first and last names online with the links that are already set in the code. At the end of the name searcher it gives an AI preview from brave. After you type someting it clears the page. It doesn't automaticly save the asked questions.
...
Just use pyton. You can download the zip and just unzip it.
Else you can use git clone https://github.com/ermwhatesigma/DeepSearch to have it in the same directonary of the folder.
DeepSearch is fully ran in Terminal or powershell. So don't try to download it in an .exe file.
