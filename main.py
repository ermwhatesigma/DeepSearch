...
while True:
    ...
    print("3. NOTHING")
    print("4. AI chat. All the conted generated after selecting this choice is AI generated. It is still experimental so it might not work.")
    print("5. Exit")
